...
public:
    ...
    std::string observationPolicyUpdate = "default";

    FloatType planningSimulationStepSize = 0.0;
    ...
    static void addABTOptions(options::OptionParser* parser) {
        ...
        parser->addOptionWithDefault<std::string>("ABT",
                ...
                "pol.pol");
        parser->addOptionWithDefault<std::string>("ABT",
                "observationPolicyUpdate",
                &ABTExtendedOptions::observationPolicyUpdate,
                "default");
    }
    ...
    static void addABTExtendedOptions(options::OptionParser* parser) {
        ...
        parser->addOptionWithDefault<FloatType>("ABT",
                                                ...
                                                std::numeric_limits<FloatType>::infinity());
        parser->addOptionWithDefault<FloatType>("ABT",
                                                "planningSimulationStepSize",
                                                &ABTExtendedOptions::planningSimulationStepSize,
                                                0.0);
        parser->addOptionWithDefault<bool>("ABT",
                                           "mlmc",
                                           &ABTExtendedOptions::mlmc,
                                           false);
        parser->addOptionWithDefault<unsigned int>("ABT",
                "maxLength",
                &ABTExtendedOptions::maxLength,
                0);
        parser->addOptionWithDefault<unsigned int>("ABT",
                "numLevels",
                &ABTExtendedOptions::numLevels,
                0);
        parser->addOptionWithDefault<unsigned int>("ABT",
                "mlmcVersion",
                &ABTExtendedOptions::mlmcVersion,
                1);

    }

    static void addDespotOptions(options::OptionParser* parser) {
        parser->addOptionWithDefault<unsigned int>("DESPOT",
                "numScenarios",
                &ABTExtendedOptions::numScenarios,
                1);
        parser->addOptionWithDefault<unsigned int>("DESPOT",
                "searchDepth",
